...
public class EmployeesTap extends android.support.v4.app.Fragment implements TextWatcher {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        lv_employees1 =(ListView)view.findViewById(R.id.lv_employees_fragment) ;
